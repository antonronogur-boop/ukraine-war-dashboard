...
if response.status_code == 200:
    ...
    if main_content:
        ...
        categories = [
            ("Tanks", "M-55S"),
            ("Armoured Fighting Vehicles", "BMPT Azovets"),
            ("Infantry Fighting Vehicles", "BMP-1(P)"),
            ("Armoured Personnel Carriers", "BTR-60PB"),
            ("Mine-Resistant Ambush Protected (MRAP) Vehicles", "Vepr"),
            ("Infantry Mobility Vehicles", "KrAZ Cobra"),
            ("Command Posts And Communications Stations", "BMP-1KSh"),
            ("Engineering Vehicles And Equipment", "IMR-2"),
            ("Unmanned Ground Vehicles", "THeMIS UGV"),
            ("Self-Propelled Anti-Tank Missile Systems", "9P148 Konkurs ATGM"),
            ("Artillery Support Vehicles And Equipment", "1V13"),
            ("Towed Artillery", "100mm BS-3"),
            ("Self-Propelled Artillery", "120mm Bars-8MMK"),
            ("Multiple Rocket Launchers", "80mm B-8 makeshift MRL"),
            ("Anti-Aircraft Guns", "23mm ZU-23"),
            ("Self-Propelled Anti-Aircraft Guns", "BTR-ZD Skrezhet"),
            ("Surface-To-Air Missile Systems", "9K33 Osa"),
            ("Radars And Communications Equipment", "P-14 'Tall King'"),
            ("Jammers And Deception Systems", "NOTA"),
            ("Aircraft", "MiG-29"),
            ("Helicopters", "Mi-2"),
            ("Unmanned Combat Aerial Vehicles", "Bayraktar TB2"),
            ("Reconnaissance Unmanned Aerial Vehicles", "A1-SM Fury"),
            ("Naval Ships and Submarines", "Krivak III-class frigate"),
            ("Trucks, Vehicles, and Jeeps", "KrAZ-214"),
        ]
        ...
        filename = 'UKR_equipment_losses_with_categories.xlsx'
        save_to_excel(df, filename)

        # Update the summation sheet with the differences
        update_summation_sheet(filename, df)

        print("Data has been saved to 'UKR_equipment_losses_with_categories.xlsx'")
else:
